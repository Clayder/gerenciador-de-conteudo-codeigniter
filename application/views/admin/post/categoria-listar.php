        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    <i class="fa fa-newspaper-o" aria-hidden="true"></i> Categorias
                ...
                <table class="table table-striped">   
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url_admin('post/categoria/servicos'); ?>" class="btn btn-info btn-lg">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url_admin('post/categoria/projetos'); ?>" class="btn btn-info btn-lg">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url_admin('post/categoria/categoria-2'); ?>" class="btn btn-info btn-lg">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url_admin('post/categoria/categoria-3'); ?>" class="btn btn-info btn-lg">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>
                            </td>
                            <td>
