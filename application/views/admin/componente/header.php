...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: #21537E">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SIGE</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        ...
                        <ul id="drop-paginas" class="collapse">
                            <li>
                                <a href="<?php echo base_url('admin/pagina'); ?>">Todas as Páginas</a>
                            </li>
                            <li>
