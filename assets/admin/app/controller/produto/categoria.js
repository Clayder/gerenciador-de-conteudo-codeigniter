angular.module('notesApp', [])
        .controller('CategoriaProduto', function ($http) {
            ...
            app.submitCadastrar = function () {
                ...
                $http.post(base_url_admin('produto/categoriaCadastrar'), app.dados).success(function (data) {
                    console.log(data);
            ...
            app.deletarCategoria = function (id, posicao) {
                ...
                if (confirm(msgExcluir)) {
                    $http.delete(base_url_admin('produto/categoriaExcluir/' + id)).success(function (data) {
                        console.log(data);
                        if (data == 1) {
            ...
            app.submitEditar = function () {
                ...
                $http.put(base_url_admin('produto/categoriaEditar'), app.dados).success(function (data) {
                    console.log(data);
                    ...
                    if (data) {
                        setTimeout(function () {
                            window.location = base_url_admin('produto/categoria/' + app.dados.id);
                        }, 1000);
                    }
